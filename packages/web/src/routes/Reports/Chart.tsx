      ...
      <div className={classes.boxLegend}>
        <List component="div">
          <ListItem component="div" classes={{ root: classes.itemRoot }}>
            ...
            <ListItemText primary={<FormatCurrency money={incomeTotal} />} secondary="Incomes" />
          </ListItem>
          <ListItem component="div" classes={{ root: classes.itemRoot }}>
            <ListItemIcon classes={{ root: classes.expenseAvatarRoot }}>
              <TurnedInRoundedIcon />
            </ListItemIcon>
            <ListItemText primary={<FormatCurrency money={expenseTotal} />} secondary="Expenses" />
          </ListItem>
          <Divider />
          <ListItem component="div" classes={{ root: classes.itemRoot }}>
            <ListItemIcon
              classes={{
                root:
                  incomeTotal > expenseTotal ? classes.incomeAvatarRoot : classes.expenseAvatarRoot,
              }}>
            ...
            <ListItemText
              primary={<FormatCurrency money={Math.abs(incomeTotal - expenseTotal)} />}
              secondary="Balance"
            />
          </ListItem>
        </List>
